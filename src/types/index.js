...
/** @typedef {{ orderItemId: number, rating: number, content?: string, images?: string, isAnonymous?: number }} ReviewDTO */
/** @typedef {{ skuId: number, quantity: number, addressId: number, remark?: string }} BuyNowDTO */
...
/** @typedef {{ orderNo: string, payType: 1 | 2 | 3 }} CreatePaymentDTO */
