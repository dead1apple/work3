...
import {
  ElButton, ElDialog, ElEmpty, ElForm, ElFormItem, ElInput, ElInputNumber, ElMessage,
...
<template>
  ...
  <el-dialog v-model="formOpen" :title="currentId === null ? '创建优惠券' : '编辑优惠券'" width="720px" :close-on-click-modal="false" :teleported="false">
    <el-form label-position="top" class="coupon-form">
      ...
      <div class="form-grid"><el-form-item label="开始时间" required><el-input v-model="couponForm.startTime" placeholder="YYYY-MM-DD HH:mm:ss" /></el-form-item><el-form-item label="结束时间" required><el-input v-model="couponForm.endTime" placeholder="YYYY-MM-DD HH:mm:ss" /></el-form-item></div>
      ...
      <div class="form-grid"><el-form-item label="领取开始时间"><el-input v-model="couponForm.receiveStartTime" placeholder="YYYY-MM-DD HH:mm:ss" /></el-form-item><el-form-item label="领取结束时间"><el-input v-model="couponForm.receiveEndTime" placeholder="YYYY-MM-DD HH:mm:ss" /></el-form-item><el-form-item label="使用开始时间"><el-input v-model="couponForm.useStartTime" placeholder="YYYY-MM-DD HH:mm:ss" /></el-form-item><el-form-item label="使用结束时间"><el-input v-model="couponForm.useEndTime" placeholder="YYYY-MM-DD HH:mm:ss" /></el-form-item></div>
    </el-form>
...
.form-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 0 var(--space-4); }.coupon-form :deep(.el-input-number), .coupon-form :deep(.el-select) { width: 100%; }.coupon-detail { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: var(--space-4); }.coupon-detail div { padding: var(--space-3); border-radius: var(--radius-small); background: var(--color-canvas); }.coupon-detail dt { color: var(--color-muted); font-size: 12px; }.coupon-detail dd { margin: var(--space-1) 0 0; font-weight: 650; }.detail-loading { min-height: 200px; }
